...
import requests
import asyncio
BASE_URL = 'https://forum.ge/?showforum=99&prune_day=100&sort_by=Z-A&sort_key=last_post&st='
...
all_pages = [BASE_URL + f'{i}' for i in range(0, 640, 40)]
...
async def main():
    ...
    async with aiohttp.ClientSession(connector=conn) as session:
        with open('forum_ge_beaut.txt', 'a', encoding='utf-8') as file:
